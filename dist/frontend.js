...
function positionMessageActionButton(button, metaPill) {
  const target = button instanceof HTMLElement ? button : button.querySelector(".scenemap-message-action");
  if (!target || !(metaPill instanceof HTMLElement))
    return;
